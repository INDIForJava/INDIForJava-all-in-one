...
public interface INDIInputStream {
     ...
     *
     * @throws IOException when something went wrong with the underlying input stream.
     */
     ...
     * @throws IOException if something went wrong with the deserialization or the
     *                     underlying stream.
     */
