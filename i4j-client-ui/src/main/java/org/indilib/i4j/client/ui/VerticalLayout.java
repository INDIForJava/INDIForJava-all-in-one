 ...
 * alignment is
 * <code>BOTH</code> in which case components are stretched horizontally. Unlike
 * FlowLayout, components will not wrap to form another column if there isn't
 * enough space vertically. VerticalLayout can optionally anchor components to
 * the top or bottom of the display area or center them between the top and
 * bottom.
 *
