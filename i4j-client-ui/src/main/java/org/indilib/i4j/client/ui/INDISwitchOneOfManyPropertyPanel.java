...
public class INDISwitchOneOfManyPropertyPanel extends INDIPropertyPanel implements INDIElementListener {
     ...
     * serial Version UID.
     */
    private static final long serialVersionUID = 7081445572254218526L;

    /**
     * information dialog for the property.
     */
    ...
    public INDISwitchOneOfManyPropertyPanel(INDISwitchProperty property) {
        ...
        List<INDISwitchElement> elems = property.getElementsAsList();

        for (int i = 0; i < elems.size(); i++) {
            INDISwitchElement se = elems.get(i);
     ...
     * 
     * @param evt
     *            the action that triggert the opening.
     */
     ...
     * 
     * @param evt
     *            the event that triggerd the action.
     */
    private void desiredValueActionPerformed(java.awt.event.ActionEvent evt) { // GEN-FIRST:event_desiredValueActionPerformed
        if (init) {
            ...
            List<INDIElement> elems = (List<INDIElement>) getProperty().getElementsAsList();
