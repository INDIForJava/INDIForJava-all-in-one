...
public class TestGsl {
    ...
    protected void gsl_test(boolean isFailed, String test_description, String... args) {
    ...
    protected void gsl_test_rel(double result, double expected, double relative_error, String test_description, Object... args) {
        boolean status;
        ...
        } else if ((expected > 0 && expected < Gsl.GSL_DBL_MIN) || (expected < 0 && expected > -(Gsl.GSL_DBL_MIN))) {
            status = false;
        } else if (expected != 0) {
    ...
    protected void gsl_test_abs(double result, double expected, double absolute_error, String test_description, Object... args) {
        boolean status;
    ...
    protected void gsl_test_factor(double result, double expected, double factor, String test_description, Object... args) {
        boolean status;

        if ((expected > 0 && expected < Gsl.GSL_DBL_MIN) || (expected < 0 && expected > -(Gsl.GSL_DBL_MIN))) {
            status = false;
    ...
    protected void gsl_test_int(int result, int expected, String test_description, Object... args) {
    ...
    protected void gsl_test_str(String result, String expected, String test_description, Object... args) {
