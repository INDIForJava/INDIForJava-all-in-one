...
public class TestCBlasDrot extends TestGsl {
...

    {
        ...
        Gsl.cblas_drot(N, X, incX, Y, incY, c, s);
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(X.get(i), x_expected.get(i), dbleps, "drot(case 566)");
            }
        }
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(Y.get(i), y_expected.get(i), dbleps, "drot(case 567)");
            }
        }
    }
    ...
    public void test_rot2() {
        ...
        Gsl.cblas_drot(N, X, incX, Y, incY, c, s);
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(X.get(i), x_expected.get(i), dbleps, "drot(case 568)");
            }
        }
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(Y.get(i), y_expected.get(i), dbleps, "drot(case 569)");
            }
        }
    }
    ...
    public void test_rot3() {
        ...
        Gsl.cblas_drot(N, X, incX, Y, incY, c, s);
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(X.get(i), x_expected.get(i), dbleps, "drot(case 570)");
            }
        }
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(Y.get(i), y_expected.get(i), dbleps, "drot(case 571)");
            }
        }
    }
    ...
    public void test_rot4() {
        ...
        Gsl.cblas_drot(N, X, incX, Y, incY, c, s);
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(X.get(i), x_expected.get(i), dbleps, "drot(case 572)");
            }
        }
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(Y.get(i), y_expected.get(i), dbleps, "drot(case 573)");
            }
        }
    }
    ...
    public void test_rot5() {
        ...
        Gsl.cblas_drot(N, X, incX, Y, incY, c, s);
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(X.get(i), x_expected.get(i), dbleps, "drot(case 582)");
            }
        }
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(Y.get(i), y_expected.get(i), dbleps, "drot(case 583)");
            }
        }
    }
    ...
    public void test_rot6() {
        ...
        Gsl.cblas_drot(N, X, incX, Y, incY, c, s);
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(X.get(i), x_expected.get(i), dbleps, "drot(case 584)");
            }
        }
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(Y.get(i), y_expected.get(i), dbleps, "drot(case 585)");
            }
        }
    }
    ...
    public void test_rot7() {
        ...
        Gsl.cblas_drot(N, X, incX, Y, incY, c, s);
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(X.get(i), x_expected.get(i), dbleps, "drot(case 586)");
            }
        }
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(Y.get(i), y_expected.get(i), dbleps, "drot(case 587)");
            }
        }
    }
    ...
    public void test_rot8() {
        ...
        Gsl.cblas_drot(N, X, incX, Y, incY, c, s);
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(X.get(i), x_expected.get(i), dbleps, "drot(case 588)");
            }
        }
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(Y.get(i), y_expected.get(i), dbleps, "drot(case 589)");
            }
        }
    }
    ...
    public void test_rot9() {
        ...
        Gsl.cblas_drot(N, X, incX, Y, incY, c, s);
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(X.get(i), x_expected.get(i), dbleps, "drot(case 598)");
            }
        }
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(Y.get(i), y_expected.get(i), dbleps, "drot(case 599)");
            }
        }
    }
    ...
    public void test_rot10() {
        ...
        Gsl.cblas_drot(N, X, incX, Y, incY, c, s);
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(X.get(i), x_expected.get(i), dbleps, "drot(case 600)");
            }
        }
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(Y.get(i), y_expected.get(i), dbleps, "drot(case 601)");
            }
        }
    }
    ...
    public void test_rot11() {
        ...
        Gsl.cblas_drot(N, X, incX, Y, incY, c, s);
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(X.get(i), x_expected.get(i), dbleps, "drot(case 602)");
            }
        }
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(Y.get(i), y_expected.get(i), dbleps, "drot(case 603)");
            }
        }
    }
    ...
    public void test_rot12() {
        ...
        Gsl.cblas_drot(N, X, incX, Y, incY, c, s);
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(X.get(i), x_expected.get(i), dbleps, "drot(case 604)");
            }
        }
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(Y.get(i), y_expected.get(i), dbleps, "drot(case 605)");
            }
        }
    }
