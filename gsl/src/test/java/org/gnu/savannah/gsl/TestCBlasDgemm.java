...
public class TestCBlasDgemm extends TestGsl {
...

	{
		...
		int lda = 4;
		DoubleArray B = new DoubleArray(-0.207, -0.916, -0.278, 0.403, 0.885,
				0.409, -0.772, -0.27);
		int ldb = 2;
		DoubleArray C = new DoubleArray(-0.274, -0.858);
		int ldc = 2;
		DoubleArray C_expected = new DoubleArray(0.0, 0.0);
		Gsl.cblas_dgemm(order, transA, transB, M, N, K, alpha, A, lda, B, ldb,
				beta, C, ldc);
		{
			int i;
			for (i = 0; i < 2; i++) {
	...
	public void test_dgemm8() {
		...
		int lda = 1;
		DoubleArray B = new DoubleArray(-0.048, -0.753, -0.8, -0.89, -0.535, -0.017,
				-0.018, -0.544);
		int ldb = 4;
	...
	public void test_dgemm2() {
		...
		int lda = 4;
		DoubleArray B = new DoubleArray(-0.089, -0.822, 0.937, 0.159, 0.789, -0.413,
				-0.172, 0.88);
		int ldb = 4;
	...
	public void test_dgemm3() {
		...
		int lda = 1;
		DoubleArray B = new DoubleArray(-0.847, 0.031, -0.938, 0.09, -0.286, -0.478,
				-0.981, 0.881);
		int ldb = 2;
	...
	public void test_dgemm4() {
		...
		int lda = 1;
		DoubleArray B = new DoubleArray(-0.525, 0.967, 0.687, -0.024, 0.527, 0.485,
				0.109, -0.46);
		int ldb = 2;
	...
	public void test_dgemm5() {
		...
		int lda = 4;
		DoubleArray B = new DoubleArray(-0.201, -0.159, -0.586, -0.016, -0.324,
				0.411, 0.115, -0.229);
		int ldb = 4;
	...
	public void test_dgemm6() {
		...
		int lda = 1;
		DoubleArray B = new DoubleArray(0.768, 0.7, 0.619, -0.478, -0.129, -0.778,
				-0.432, 0.454);
		int ldb = 4;
	...
	public void test_dgemm7() {
		...
		int lda = 4;
		DoubleArray B = new DoubleArray(-0.142, 0.778, 0.359, 0.622, -0.637, -0.757,
				-0.282, -0.805);
		int ldb = 2;
