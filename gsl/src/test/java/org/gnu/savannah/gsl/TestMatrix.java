...
public class TestMatrix extends TestGsl {
    ...
    void test_func(int M, int N) {
...

        {
            ...
            isFailed = !m.isNonNeg();
            gsl_test(isFailed, "_isnonneg" + " gsl_matrix " + " on calloc matrix");
        }
        ...
        {
            isFailed = m.isNull();
            gsl_test(isFailed, "_isnull" + " gsl_matrix " + " on non-negative matrix");

            isFailed = m.isPos();
            gsl_test(isFailed, "_ispos" + " gsl_matrix " + " on non-negative matrix");

            isFailed = m.isNeg();
            gsl_test(isFailed, "_isneg" + " gsl_matrix " + " on non-negative matrix");

            isFailed = !m.isNonNeg();
            gsl_test(isFailed, "_isnonneg" + " gsl_matrix " + " on non-negative matrix");
        }
...

        {
            ...
            isFailed = m.isNonNeg();
            gsl_test(isFailed, "_isnonneg" + " gsl_matrix " + " on mixed matrix");
        }
        ...
        {
            isFailed = m.isNull();
            gsl_test(isFailed, "_isnull" + " gsl_matrix " + " on non-positive matrix");

            isFailed = m.isPos();
            gsl_test(isFailed, "_ispos" + " gsl_matrix " + " on non-positive matrix");

            isFailed = m.isNeg();
            gsl_test(isFailed, "_isneg" + " gsl_matrix " + " on non-positive matrix");

            isFailed = m.isNonNeg();
            gsl_test(isFailed, "_isnonneg" + " gsl_matrix " + " on non-positive matrix");
        }
        ...
        {
            isFailed = m.isNull();
            gsl_test(isFailed, "_isnull" + " gsl_matrix " + " on positive matrix");

            isFailed = !m.isPos();
            gsl_test(isFailed, "_ispos" + " gsl_matrix " + " on positive matrix");

            isFailed = m.isNeg();
            gsl_test(isFailed, "_isneg" + " gsl_matrix " + " on positive matrix");

            isFailed = !m.isNonNeg();
            gsl_test(isFailed, "_isnonneg" + " gsl_matrix " + " on positive matrix");
        }
        ...
        {
            isFailed = m.isNull();
            gsl_test(isFailed, "_isnull" + " gsl_matrix " + " on negative matrix");

            isFailed = m.isPos();
            gsl_test(isFailed, "_ispos" + " gsl_matrix " + " on negative matrix");

            isFailed = !m.isNeg();
            gsl_test(isFailed, "_isneg" + " gsl_matrix " + " on negative matrix");

            isFailed = m.isNonNeg();
            gsl_test(isFailed, "_isnonneg" + " gsl_matrix " + " on negative matrix");
        }
