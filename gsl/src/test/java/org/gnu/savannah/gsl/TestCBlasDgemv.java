...
public class TestCBlasDgemv extends TestGsl {
    ...
    public void test_gemv1() {
        ...
        Gsl.cblas_dgemv(order, trans, M, N, alpha, A, lda, X, incX, beta, Y, incY);
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(Y.get(i), y_expected.get(i), dbleps, "dgemv(case 778)");
            }
        }
    }
    ...
    public void test_gemv2() {
        ...
        Gsl.cblas_dgemv(order, trans, M, N, alpha, A, lda, X, incX, beta, Y, incY);
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(Y.get(i), y_expected.get(i), dbleps, "dgemv(case 779)");
            }
        }
    }
    ...
    public void test_gemv3() {
        ...
        Gsl.cblas_dgemv(order, trans, M, N, alpha, A, lda, X, incX, beta, Y, incY);
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(Y.get(i), y_expected.get(i), dbleps, "dgemv(case 780)");
            }
        }
    }
    ...
    public void test_gemv4() {
        ...
        Gsl.cblas_dgemv(order, trans, M, N, alpha, A, lda, X, incX, beta, Y, incY);
        {
            int i;
            for (i = 0; i < 1; i++) {
                gsl_test_rel(Y.get(i), y_expected.get(i), dbleps, "dgemv(case 781)");
            }
        }
    }
}
