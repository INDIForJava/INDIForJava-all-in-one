...
public interface INDIServerInterface {
     ...
     *
     * @param cls the class
     * @throws INDIException if the classes could not be loded or not started.
     */
     ...
     *
     * @param cls the class
     * @throws INDIException if the classes could not be loaded or not started.
     */
     ...
     *
     * @param jarFileName the file name of the jar
     * @throws INDIException if the classes could not be loaded or not started.
     */
     ...
     *
     * @param name      the acceport name
     * @param arguments the arguments for the acceptor.
     */
     ...
     * connection.
     *
     * @param indiConnection the connection to add.
