...
public class MathPluginManagement extends INDIDriverExtension<INDITelescope> {
     ...
     * drivers.
     *
     * @param driver the telescope driver.
     */
     ...
     *
     * @param elementsAndValues the new values for the button.
     */
     ...
     * not really change)
     *
     * @param elementsAndValues the new values for the selected plugin.
     */
     ...
     *
     * @param currentPlugin the current plugin.
     */
     ...
     *
     * @param approximateAlignment the alignment to set.
     */
     ...
     * @param apparentTelescopeDirectionVector Parameter to receive the corrected telescope direction
     * @return True if successful
     */
     ...
     * direction.
     *
     * @param apparentTelescopeDirectionVector the telescope direction
     * @param julianOffset                     to be applied to the current julian date.
