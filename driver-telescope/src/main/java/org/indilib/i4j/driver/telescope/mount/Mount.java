 ...
 *
 * @param <AxisWithEncoderType> the type for the axis.
 */
public class Mount<AxisWithEncoderType extends AxisWithEncoder> {
     ...
     *
     * @param horizontalDegrees the horizontal axis coordinates.
     * @param verticalDegrees   the vertical axis coordinates.
     * @param secondsInFuture   the alloted time to reach the coordinates.
     */
