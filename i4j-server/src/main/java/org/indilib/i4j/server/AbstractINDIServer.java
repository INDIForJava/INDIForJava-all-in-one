 ...
 * (which consist on other INDI Servers). New INDI Servers that implement
 * additional functionality may inherit from this class.
 * 
...
public abstract class AbstractINDIServer implements Runnable {
     ...
     * 
     * @param jarFileName
     *            The jar file from which to load Drivers.
     * @throws INDIException
     *             if there is a problem with the JAR file
     */
    ...
    private void addDevice(INDIDevice device) {
        ...
        String message = "<getProperties version=\"1.7\" />"; // Force the
                                                              // device to send
                                                              // its properties
                                                              // for already
                                                              // connected
    ...
    /**
     * Notifies Clients of a <code>setXXXVector</code> message.
     * 
     * @param device
     *            The Device sending the message.
     * @param xml
    ...
    /**
     * Notifies Clients of a <code>message</code> message.
     * 
     * @param device
     *            The Device sending the message.
     * @param xml
    ...
    /**
     * Notifies Clients of a <code>delProperty</code> message.
     * 
     * @param device
     *            The Device sending the message.
     * @param xml
    ...
    /**
     * Notifies Devices of a <code>getProperties</code> message.
     * 
     * @param client
    ...
    /**
     * Notifies Devices of a <code>newXXXVector</code> message.
     * 
     * @param client
     *            The Client sending the message.
     * @param xml
    ...
    /**
     * Notifies Devices of a <code>enableBLOB</code> message (if necessary).
     * Usually it is not necessary to send any message to the Devices about this
     * since the control of BLOB property changes is automatically done in the
     * Server.
     * 
     * @param client
     *            The Client sending the message.
     ...
     * @param deviceNames
     *            The name of the devices that are no longer available.
     */
