 ...
 * implements all the abstract methods of <code>AbstractINDIServer</code> to
 * allow any client that connects to access any device that the Server loads.
 * New Servers that do not implement specific restrictions may extend this class
 * instead of the AbstractINDIServer.
 * 
