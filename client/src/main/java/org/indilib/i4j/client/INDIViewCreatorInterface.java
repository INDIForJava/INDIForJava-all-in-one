...
public interface INDIViewCreatorInterface {
     ...
     *
     * @param indiDevice the device to listen to
     * @return the created device listener
     * @throws INDIException if something unexpected went wrong.
     */
     ...
     *
     * @param indiblobElement the blob element to create a view for
     * @param permission      the permissions for the parent property
     ...
     *
     * @param indiLightElement the light element to create a view for
     * @param permission       the permissions for the parent property
     * @return the element listener around the view
     * @throws INDIException if something unexpected went wrong.
     */
     ...
     *
     * @param indiNumberElement the number element to create a view for
     * @param permission        the permissions for the parent property
     * @return the element listener around the view
     * @throws INDIException if something unexpected went wrong.
     */
     ...
     *
     * @param indiSwitchElement the switch element to create a view for
     * @param permission        the permissions for the parent property
     * @return the element listener around the view
     * @throws INDIException if something unexpected went wrong.
     */
     ...
     *
     * @param indiTextElement the text element to create a view for
     * @param permission      the permissions for the parent property
     * @return the element listener around the view
     * @throws INDIException if something unexpected went wrong.
     */
     ...
     *
     * @param indiProperty the blob property to create the view for.
     ...
     *
     * @param indiProperty the number property to create the view for.
     * @return the property listener of the view.
     * @throws INDIException if something unexpected went wrong.
     */
     ...
     *
     * @param indiProperty the text property to create the view for.
     * @return the property listener of the view.
     * @throws INDIException if something unexpected went wrong.
     */
     ...
     *
     * @param indiProperty the switch property to create the view for.
     * @return the property listener of the view.
     * @throws INDIException if something unexpected went wrong.
     */
     ...
     *
     * @param indiProperty the light property to create the view for.
     * @return the property listener of the view.
     * @throws INDIException if something unexpected went wrong.
     */
     ...
     *
     * @param indiDevice the device to create the view for.
