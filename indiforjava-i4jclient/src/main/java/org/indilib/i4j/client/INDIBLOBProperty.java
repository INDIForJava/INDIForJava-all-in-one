...
public class INDIBLOBProperty extends INDIProperty {
   ...
   *
   * @param xml A XML Element <code>&lt;defBLOBVector&gt;</code> describing the
   * Property.
   ...
   */
  protected INDIBLOBProperty(Element xml, INDIDevice device) throws IllegalArgumentException {
    super(xml, device);
  ...
  public INDIPropertyListener getDefaultUIComponent() throws INDIException {
    ...
    String[] possibleUIClassNames = new String[]{"org.indilib.i4j.client.ui.INDIDefaultPropertyPanel", "org.indilib.i4j.androidui.INDIDefaultPropertyView"};
