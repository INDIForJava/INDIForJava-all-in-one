...
public class INDIDevice {
   ...
   *
   * @throws IOException if there is some problem sending the message.
   * @deprecated Replaced by {@link #BLOBsEnable(org.indilib.i4j.Constants.BLOBEnables)}
   */
  @Deprecated
   ...
   * @throws IOException if there is some problem sending the message.
   * @deprecated Replaced by {@link #BLOBsEnable(org.indilib.i4j.Constants.BLOBEnables, INDIProperty)}
   */
  @Deprecated
  ...
  public INDIDeviceListener getDefaultUIComponent() throws INDIException {
    ...
    String[] possibleUIClassNames = new String[]{"org.indilib.i4j.client.ui.INDIDevicePanel", "org.indilib.i4j.androidui.INDIDeviceView"};
    try {
