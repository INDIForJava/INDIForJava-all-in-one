...
public class INDIDeviceController extends INDIController<INDIDevice> implements INDIDeviceListener {
    ...
    private Map<String, FxController<Parent, INDIGroupController>> groupMap = new HashMap<>();
    ...
    public void newProperty(INDIDevice device, INDIProperty<?> property) {
        FxController<Parent, INDIGroupController> fxGroup = groupMap.get(property.getGroup());
        if (fxGroup == null) {
