...
public class INDISwitchProperty extends INDIProperty<INDISwitchElement> {
    ...
    /**
     * Loads an instance of <code>INDISwitchProperty</code> from a file or, if
     * it cannot be loaded, constructs it with a particular <code>driver</code>,
     * <code>name</code>, <code>label</code>, <code>group</code>,
     * <code>state</code>, <code>permission</code>, <code>timeout</code> and
     ...
     * it cannot be loaded, constructs it with a particular <code>driver</code>,
     * <code>name</code>, <code>label</code>, <code>group</code>,
     * <code>state</code>, <code>permission</code> and <code>rule</code>. The
     ...
     * Constructs an instance of <code>INDISwitchProperty</code> with a
     * particular <code>driver</code>, <code>name</code>, <code>label</code>,
     * <code>state</code>, <code>permission</code>, <code>rule</code>, and a 0
     * timeout and default group.
     * 
     * @param driver
     *            The Driver to which this property is associated.
     * @param name
     ...
     * Loads an instance of <code>INDISwitchProperty</code> from a file or, if
     * it cannot be loaded, constructs it with a particular <code>driver</code>,
     * <code>name</code>, <code>label</code>, <code>state</code>,
     * <code>permission</code> and <code>rule</code>. The property will autosave
     ...
     * Loads an instance of <code>INDISwitchProperty</code> from a file or, if
     * it cannot be loaded, constructs it with a particular <code>driver</code>,
     * <code>name</code>, <code>state</code>, <code>permission</code> and
     * <code>rule</code>. The property will autosave its status to a file every
     * time that it is changed.
     * 
     * @param driver
