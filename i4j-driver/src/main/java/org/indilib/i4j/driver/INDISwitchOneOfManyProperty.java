...
public class INDISwitchOneOfManyProperty extends INDISwitchProperty {
     ...
     * <code>timeout</code>, <code>elements</code> and
     ...
     */
    public INDISwitchOneOfManyProperty(INDIDriver driver, String name, String label, String group, PropertyStates state, PropertyPermissions permission, int timeout,
            String[] elements, int selectedElement) {
    ...
    public static INDISwitchOneOfManyProperty createSaveableSwitchOneOfManyProperty(INDIDriver driver, String name, String label, String group, PropertyStates state,
            PropertyPermissions permission, int timeout, String[] elements, int selectedElement) {
     ...
     * particular <code>driver</code>, <code>name</code>, <code>label</code>,
     * <code>group</code>, <code>state</code>, <code>permission</code>,
     * <code>timeout</code> and <code>elements</code>.
     * 
     * @param driver
     *            The Driver to which this property is associated.
     * @param name
     ...
     * <code>driver</code>, <code>name</code>, <code>label</code>,
     * <code>group</code>, <code>state</code>, <code>permission</code>,
     * <code>timeout</code> and <code>elements</code>. The property will
     ...
     */
    public static INDISwitchOneOfManyProperty createSaveableSwitchOneOfManyProperty(INDIDriver driver, String name, String label, String group, PropertyStates state,
            PropertyPermissions permission, int timeout, String[] elements) {
        INDISwitchOneOfManyProperty sp = loadSwitchOneOfManyProperty(driver, name);
     ...
     * Constructs an instance of <code>INDISwitchOneOfManyProperty</code> with a
     * particular <code>driver</code>, <code>name</code>, <code>label</code>,
     * <code>state</code>, <code>permission</code>, <code>elements</code> and
     * <code>selectedElement</code>.
     * 
     * @param driver
     *            The Driver to which this property is associated.
     ...
     * @see INDISwitchProperty
     */
    public static INDISwitchOneOfManyProperty createSaveableSwitchOneOfManyProperty(INDIDriver driver, String name, String label, PropertyStates state,
            PropertyPermissions permission, String[] elements, int selectedElement) {
        INDISwitchOneOfManyProperty sp = loadSwitchOneOfManyProperty(driver, name);
     ...
     * Constructs an instance of <code>INDISwitchOneOfManyProperty</code> with a
     * particular <code>driver</code>, <code>name</code>, <code>label</code>,
     * <code>state</code>, <code>permission</code> and <code>elements</code>.
     * 
     * @param driver
     *            The Driver to which this property is associated.
     * @param name
     ...
     * <code>permission</code>, <code>elements</code> and
     * <code>selectedElement</code>.
     * 
     * @param driver
     *            The Driver to which this property is associated.
     ...
     * @see INDISwitchProperty
     */
    public static INDISwitchOneOfManyProperty createSaveableSwitchOneOfManyProperty(INDIDriver driver, String name, PropertyStates state, PropertyPermissions permission,
            String[] elements, int selectedElement) {
        INDISwitchOneOfManyProperty sp = loadSwitchOneOfManyProperty(driver, name);
     ...
     * Constructs an instance of <code>INDISwitchOneOfManyProperty</code> with a
     * particular <code>driver</code>, <code>name</code>, <code>state</code>,
     * <code>permission</code> and <code>elements</code>.
     * 
     * @param driver
     *            The Driver to which this property is associated.
     * @param name
     ...
     * or, if it cannot be loaded, constructs it with a particular
     * <code>driver</code>, <code>name</code>, <code>state</code>,
     * <code>permission</code> and <code>elements</code>. The property will
     * autosave its status to a file every time that it is changed.
     * 
     * @param driver
     *            The Driver to which this property is associated.
