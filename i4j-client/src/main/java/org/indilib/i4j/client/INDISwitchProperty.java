...
public class INDISwitchProperty extends INDIProperty {
  ...
  public INDIPropertyListener getDefaultUIComponent() throws INDIException {
    ...
    if (getName().equals("CONNECTION")) {
      possibleUIClassNames = new String[]{"org.indilib.i4j.client.ui.INDIConnectionPropertyPanel", "org.indilib.i4j.client.ui.INDIDefaultPropertyPanel", "org.indilib.i4j.androidui.INDIDefaultPropertyView"};
    } else if (rule == SwitchRules.ONE_OF_MANY) {
      possibleUIClassNames = new String[]{"org.indilib.i4j.client.ui.INDISwitchOneOfManyPropertyPanel", "org.indilib.i4j.androidui.INDIDefaultPropertyView"};
    } else {
      possibleUIClassNames = new String[]{"org.indilib.i4j.client.ui.INDIDefaultPropertyPanel", "org.indilib.i4j.androidui.INDIDefaultPropertyView"};
    }
